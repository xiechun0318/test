========================================================================
    コンソール アプリケーション: CodedStructuredLight_decode プロジェクトの概要
========================================================================

この CodedStructuredLight_decode アプリケーションは、AppWizard により作成されました。

このファイルには、CodedStructuredLight_decode アプリケーションを構成する各ファイルの内容の概要が含まれています。


CodedStructuredLight_decode.vcxproj
...
CodedStructuredLight_decode.vcxproj.filters
...
CodedStructuredLight_decode.cpp
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、CodedStructuredLight_decode.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。
